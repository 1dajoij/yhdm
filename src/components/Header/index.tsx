...
export default function index() {
  ...
  return (
    ...
    >
        <div className="flex items-center bg-transparent h-100%"
        style={{opacity: !open?"0":"1", transition: ".2s"}}
        >
          <ul className="nav h-100% flex items-center p-x-58px bg-white">
          ...
          <div className="search_input p-x-42px overflow-hidden flex h-100% items-center bg-white">
          ...
          <ul className="icon_list bg-white p-r-72px h-100% flex items-center">
            <li className="history flex items-center cursor-pointer">
              <img src={history} alt="历史记录" />
            </li>
          </ul>
          {
            // 暂时不确定有没有用户的功能
